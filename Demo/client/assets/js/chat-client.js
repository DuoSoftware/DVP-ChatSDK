...
var elementAction = (function () {
  return {
    ...
    joinFormEnable: function () {
      ...
      document
        .getElementById("agentState")
        .classList.remove("chat-online-agent");
...
var OnConnected = function () {
  ...
  var tok = decodeURIComponent(
    window.location.search.replace(
      new RegExp(
        "^(?:.*[&\\?]" +
          encodeURIComponent("veeryToken").replace(/[\.\+\*]/g, "\\$&") +
          "(?:\\=([^&]*))?)?.*$",
        "i"
      ),
      "$1"
  ...
  var attributes = decodeURIComponent(
    window.location.search.replace(
      new RegExp(
        "^(?:.*[&\\?]" +
  ...
  var company_name = decodeURIComponent(
    window.location.search.replace(
      new RegExp(
        "^(?:.*[&\\?]" +
  ...
  var name = decodeURIComponent(
    window.location.search.replace(
      new RegExp(
        "^(?:.*[&\\?]" +
          encodeURIComponent("companyName").replace(/[\.\+\*]/g, "\\$&") +
          "(?:\\=([^&]*))?)?.*$",
        "i"
      ),
      "$1"
...
var connect = function () {
  ...
  document.getElementById("typing").style.display = "none";
  var token = getJsonWebToken(cData);

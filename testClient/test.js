...
window.SE = function (e) {
    ...
    function r(e) {
        if (!e)throw g;
        var r = t(e, "clientId"), o = t(e, "channelUrl"), n = t(e, "complete"), d = window.location.protocol, w = d.substring(0, d.length - 1), u = (d + "//" + window.location.host).toLowerCase();
        if (c = t(e, "key"), i = r, a = o, 0 !== a.toLowerCase().indexOf(u))throw"channelUrl must be under the current domain";
        s = h + "/oauth/dialog?redirect_uri=" + l(h + "/oauth/login_success?assisted=" + r + "&protocol=" + w + "&proxy=" + l(a)), setTimeout(function () {
            n({"version": "24452"})
        })
    }
    ...
    function o(t, r, o, n) {
        for (var i, s = "sec" + u++, a = m, d = function (a) {
            ...
            }), void 0) : (o({"accessToken": t, "expirationDate": r, "networkUsers": a.items}), void 0)
    ...
    function n(e) {
        if (!e)throw g;
        var r, n, a, c, w, m = t(e, "success"), f = e.scope, v = "", k = u++, x = s + "&client_id=" + i + "&state=" + k, y = e.error;
        ...
        f && (v = f.join(" ")), v.length > 0 && (x += "&scope=" + l(v)), c = function (t) {
            if (t.origin === h && t.source === a) {
                var n, i, s, d, w = t.data.substring(1).split("&"), l = {};
                ...
                if (+l.state === k)return r && window.removeEventListener("message", c), a.close(), (i = l.access_token) ? (n = l.expires, n && (n = new Date((new Date).getTime() + 1e3 * n)), e.networkUsers ? o(i, n, m, y) : m({
                    "accessToken": i,
                    "expirationDate": n
                }), void 0) : (y && y({"errorName": l.error, "errorMessage": l.error_description}), void 0)
            }
            ...
            if (a) {
                ...
                e && (clearInterval(w), c({"origin": h, "source": a, "data": e.location.hash}))
            }
        }, w = setInterval(n, 50)) : (r = !0, window.addEventListener("message", c)), a = window.open(x, p, "width=660,height=480")
    }

    var i, s, a, c, d = window.navigator.userAgent, w = window.document, l = window.encodeURIComponent, u = 1, p = "sew" + u++, h = "https://stackexchange.com", m = "https://api.stackexchange.com/2.0/me/associated", g = "must pass an object";
    return {"authenticate": n, "init": r}
}();